              ...
              <tr>
                ...
                <td style="padding-top: 20px">
                  ...
                  @if($schedule->isNotStart())
                    <label class="label label-primary"><i class="fa fa-clock-o" aria-hidden="true"></i> Class has not Started</label>
                  @endif
                  @if($schedule->isEnd())
                    <label class="label label-danger"><i class="fa fa-minus-circle" aria-hidden="true"></i> Class has Ended</label>
                  @endif
                </td>
